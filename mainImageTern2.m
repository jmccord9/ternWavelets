function [Itrans,Imid1,Imid2] = mainImageTern2(I,keepratio)
...
theta = [-0.261582176 0.107465734 -0.461363266];
...
Itrans = zeros(size(I));
for i=1:size(M,1)
    I = tern2ImageTransform(u,I,1);
    I = permute(tern2ImageTransform(u,permute(I,[2 1 3]),1), [2 1 3]);
